...
public class Cuboid2 {
    ...
    private float[] edgeColor = {37f/256f, 58f/256f, 190f/256f}; // default is blue
    ...
    private final ByteBuffer indexArray4faces;
    private final ByteBuffer indexArray4edges;
    ...
    public Cuboid2(float dx, float dy, float dz) {
        ...
        indexArray4faces = ByteBuffer.allocateDirect(6 * 6)
                .put(new byte[]{
        ...
        indexArray4faces.position(0);
        indexArray4edges = ByteBuffer.allocateDirect(6 * 6)
                .put(new byte[]{
    ...
    public void draw(int aPositionLocation, int uColorLocation, int useGlobalColorLocation,
        ...
        GLES20.glDrawElements(GLES20.GL_LINES, nbIndexes4lines, GLES20.GL_UNSIGNED_BYTE, indexArray4edges);
        ...
        GLES20.glDrawElements(GLES20.GL_TRIANGLES, nbIndexes4triangles, GLES20.GL_UNSIGNED_BYTE, indexArray4faces);
